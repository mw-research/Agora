...
const TEXTE = {
  de: {
    ...
    "wissen.knopf": "Eigenes Material",
    "wissen.knopfMit": "Eigenes Material ({anzahl})",
    "wissen.knopfTitel": "Unterlagen, die nur dieser Agent kennt",
    "wissen.titel": "Eigenes Material von {name}",
    "wissen.hinweis":
      "Nur dieser Agent kennt diese Unterlagen – so entsteht eine eigene Perspektive. Sie liegen in jedem seiner Aufrufe, wie die Persona: was hier steht, wird in jeder Runde neu bezahlt. Der Agent darf daraus zitieren; ein Geheimnis ist es also nicht.",
    "wissen.zeichen": "Zeichen",
    "wissen.umfang": "Zusammen {zeichen} Zeichen – rund {token} Token pro Runde.",
    "wissen.leer": "Noch nichts hinterlegt.",
    "wissen.entfernen": "entfernen",
    "wissen.vermerkTitel":
      "Dieser Teilnehmer bringt {anzahl} eigene Unterlage(n) mit, die die anderen nicht kennen",
    "allgemein.schliessen": "Schließen",
    "forum.geschlossenTitel": "Geschlossen – nur Mitglieder sehen es",
    "forum.mitgliederTitel": "Mitglieder",
    "forum.mitgliederTitel2": "Wer ist in „{name}“?",
    "forum.mitgliederHinweis":
      "Jedes Mitglied darf weitere hereinholen. Admins sehen den Raum nicht – löschen können sie ihn trotzdem, ungesehen und samt Inhalt.",
    "forum.dazuholen": "Dazuholen",
    "forum.hinauswerfen": "entfernen",
    "forum.selbstGehen": "selbst verlassen",
    "neuesForum.geschlossen": "Geschlossenes Forum",
    "neuesForum.geschlossenHinweis":
      "Nur Mitglieder sehen es, auch Admins nicht – und alles, was darunter liegt, ist ebenfalls zu. Die Beiträge liegen trotzdem im Klartext in der Datenbank und gehen in jede Sicherung mit.",
  ...
  en: {
    ...
    "wissen.knopf": "Own material",
    "wissen.knopfMit": "Own material ({anzahl})",
    "wissen.knopfTitel": "Documents only this agent knows",
    "wissen.titel": "Material held by {name}",
    "wissen.hinweis":
      "Only this agent knows these documents – that is what gives it its own perspective. They sit in every one of its calls, like the persona: whatever is here is paid for again every round. The agent may quote from it, so it is not a secret.",
    "wissen.zeichen": "characters",
    "wissen.umfang": "{zeichen} characters in total – roughly {token} tokens per round.",
    "wissen.leer": "Nothing yet.",
    "wissen.entfernen": "remove",
    "wissen.vermerkTitel":
      "This participant brings {anzahl} document(s) of its own that the others do not have",
    "allgemein.schliessen": "Close",
    "forum.geschlossenTitel": "Closed – only members see it",
    "forum.mitgliederTitel": "Members",
    "forum.mitgliederTitel2": "Who is in \u201c{name}\u201d?",
    "forum.mitgliederHinweis":
      "Any member may bring others in. Admins do not see the room – they can still delete it, unseen and with everything in it.",
    "forum.dazuholen": "Add",
    "forum.hinauswerfen": "remove",
    "forum.selbstGehen": "leave",
    "neuesForum.geschlossen": "Closed board",
    "neuesForum.geschlossenHinweis":
      "Only members see it, admins included – and everything below it is closed too. The posts still sit in the database as plain text and go into every backup.",
  ...
  ru: {
    ...
    "wissen.knopf": "Свои материалы",
    "wissen.knopfMit": "Свои материалы ({anzahl})",
    "wissen.knopfTitel": "Документы, известные только этому агенту",
    "wissen.titel": "Материалы агента {name}",
    "wissen.hinweis":
      "Эти документы знает только этот агент — отсюда и его собственная точка зрения. Они входят в каждый его запрос, как и персона: за всё, что здесь лежит, платится в каждом раунде. Агент может цитировать их, так что это не тайна.",
    "wissen.zeichen": "символов",
    "wissen.umfang": "Всего {zeichen} символов — примерно {token} токенов за раунд.",
    "wissen.leer": "Пока ничего нет.",
    "wissen.entfernen": "убрать",
    "wissen.vermerkTitel":
      "У этого участника есть свои материалы ({anzahl}), которых нет у остальных",
    "allgemein.schliessen": "Закрыть",
    "forum.geschlossenTitel": "Закрытый — виден только участникам",
    "forum.mitgliederTitel": "Участники",
    "forum.mitgliederTitel2": "Кто в «{name}»?",
    "forum.mitgliederHinweis":
      "Любой участник может пригласить других. Администраторы раздел не видят — но удалить его могут, не заглядывая внутрь, вместе со всем содержимым.",
    "forum.dazuholen": "Добавить",
    "forum.hinauswerfen": "убрать",
    "forum.selbstGehen": "выйти",
    "neuesForum.geschlossen": "Закрытый раздел",
    "neuesForum.geschlossenHinweis":
      "Его видят только участники, администраторы тоже нет — и всё, что под ним, закрыто. Сообщения всё равно лежат в базе открытым текстом и попадают в резервную копию.",
